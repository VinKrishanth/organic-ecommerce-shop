...
function BannerBigXL({navigationURL}) {
    return (
        <div className={`flex justify-end items-center min-h-[358px] max-w-[1320px]  rounded-xl overflow-hidden relative hover:border-black hover:border-opacity-50 `}>
            ...
            <div className={`flex flex-col gap-4 text-white absolute text-left z-20 pr-32 `}>
                ...
                <IconButton 
                  ...
                  btnStyle= {`flex justify-center items-center bg-Primary min-w-[162px] min-h-[51px] max-w-[192px] rounded-full`}
                />
            </div>
        </div>
      )
