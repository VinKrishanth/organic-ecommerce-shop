...
export const  Black247 = Black247Source
export const  Green247 = Green247Source
export const  WhiteMoneyBox = WhiteMoneyBoxSource
export const  BlackMoneyBox = BlackMoneyBoxSource
export const  GreenMoneyBox = GreenMoneyBoxSource
export const  WhiteShopping = WhiteShoppingSource
export const  BlackShopping = BlackShoppingSource
export const  GreenShopping = GreenShoppingSource
