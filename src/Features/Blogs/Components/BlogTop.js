...
function BlogTop({gridColSize}) {
  return (
    <div className={`grid grid-cols-12 min-w-full gap-16`}>
        <div className={`${gridColSize ? 'col-span-3' : 'col-span-4'}`}>
        ...
        <div className={`flex justify-between items-center ${gridColSize ? 'col-span-9' : 'col-span-8'}`}>
