...
function Comments() {
  ...
  return (
    <div className={`flex justify-start items-start min-w-full min-h-64  col-span-1 relative overflow-x-hidden`}>
        ...
        <div className={`grid grid-cols-1 min-w-full gap-4 border-2 rounded-md hover:px-8 hover:py-16 border-white hover:border-Gray05 transition-all duration-1000 delay-300 ease-linear`}>
