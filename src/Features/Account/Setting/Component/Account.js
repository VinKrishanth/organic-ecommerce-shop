...
function Account() {
  ...
  return (
    <div className={`flex justify-center items-center col-span-4`}>
       <div className={`flex flex-col justify-start items-center  min-w-[224px] min-h-[289px] gap-4 rounded-full`}>
          <figure className={`flex justify-center items-center max-w-[224px] max-h-[224px] cursor-pointer rounded-full overflow-hidden `}>
            <img 
              src={profileImage} 
