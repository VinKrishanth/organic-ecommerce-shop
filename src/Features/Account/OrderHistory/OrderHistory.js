...
import OrderHistoryGet from '../Dashboard/Components/OrderHistory';
import demoHistoryAll from './Components/demoHistory2.js';
import PageNavigate from './Components/PageNavigate.js';
  ...
  return (
    <section  className={`${customerStyle.container} ${customerStyle.dxl} ${customerStyle.xl} ${customerStyle.lg} ${customerStyle.md} ${customerStyle.sm} ${customerStyle.base} flex gap-8`}>
      ...
      <div className={`flex-grow grid grid-cols-9 gap-4`}>
        <OrderHistoryGet historyData={demoHistoryAll} Title={'Order History'}/>
        <PageNavigate />
      </div>
    </section>
  )
